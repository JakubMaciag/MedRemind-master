...
/*
Provider do obsługi pobierania i wrzucania danych do baz danych/systemu.
Komunikacja pomiędzy bazami danych a aplikacją - w obie strony
...
// połączenie z Uri i konkretnym powiadomieniem
...
//określenie kolejki powiadomien względem baz danych - tworzenie kursora
    @Nullable
    @Override
    ...
    @Nullable
    @Override
    //pobranie typu contentu z bazy URI
    ...
    @Nullable
    @Override
    //wrzucanie powiadomienia do URi
    ...
    //wrzucanie powiadomienia do pomocniczej DB
    ...
    //usuwanie powiadomienia z baz danych
    @Override
    ...
    //odświeżanie powiadomienia w bazach danych
    @Override
