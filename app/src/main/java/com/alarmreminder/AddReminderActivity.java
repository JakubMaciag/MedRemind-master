...
import com.alarmreminder.data.AlarmReminderContract;
import com.alarmreminder.reminder.AlarmScheduler;
...
/*
klasa do wprowadzania danych do powiadomienia
 */
public class AddReminderActivity extends AppCompatActivity implements
    ...
    private EditText mTitleText, mDescription,mAmount;
    ...
    private String mTitle,mDesc,mAmo;
...
//listener do strzałki powrotu natoolbarze
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDescription=(EditText)findViewById(R.id.reminder_description) ;
        mAmount=(EditText) findViewById(R.id.reminder_amount);
        ...
        // Setup Reminder Title EditText - listeners
        ...
        // Setup Reminder Description EditText -listeners
        ...
        if (savedInstanceState != null) {
            //dividing string message into title/description/type
            String savedT = savedInstanceState.getString(KEY_TITLE);
            String[] parts = savedT.split("/",3);
            mTitleText.setText(parts[0]);
            mTitle = parts[0];
            mDescription.setText(parts[1]);
            mDesc = parts[1];
            mAmount.setText(parts[2]);
            mAmo = parts[2];
    ...
    //przekazanie informacji do sekwencji, przekazywanejpozniej do providera
    @Override
    protected void onSaveInstanceState (Bundle outState) {
        super.onSaveInstanceState(outState);

        outState.putCharSequence(KEY_TITLE, mTitleText.getText()+"/"+mDescription.getText()+"/"+mAmount.getText());
...
// obsługa menu - zapisz/usun/wyskakujące informacje o błędach
    @Override
    ...
    //informacja o niezapisaniu powiadomienia
...
//potwierdzenie usunięcia powiadomienia
...
//przekazanie danych do bazy uri
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_TITLE, mTitle+"/"+mDesc+"/"+mAmo);
...
//tworzenie kursora do providera
    @Override
...
//pobranie danych z providera/bazy
    @Override
...
// ATTENTION - dividing string into 3 variables
            // Extract out the value from the Cursor for the given column index
            String help9 = cursor.getString(titleColumnIndex);
...
//here
            String[] part = help9.split("/");
            mTitleText.setText(part[0]);
            mDescription.setText(part[1]);
            mAmount.setText(part[2]);
